...
pub const MAX_CACHE_ENTRY_DATA_SIZE: usize =
    MAX_KEY_LENGTH + MAX_VAL_LENGTH + MEMCACHED_GET_PACKET_HEADER_EXTRAS_LENGTH as usize;
...
pub struct CacheEntry {
    ...
    pub valid: bool,
    pub hash: u32,
    pub data: [u8; MAX_CACHE_ENTRY_DATA_SIZE],
}
